  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved trunk as @trunk" do
        ...
        post :create, {:trunk => { "name" => "invalid value" }}, valid_session
        assigns(:trunk).should be_a_new(Trunk)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested trunk" do
        ...
        Trunk.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => trunk.to_param, :trunk => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the trunk as @trunk" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Trunk.any_instance.stub(:save).and_return(false)
        put :update, {:id => trunk.to_param, :trunk => { "name" => "invalid value" }}, valid_session
        assigns(:trunk).should eq(trunk)
      end
