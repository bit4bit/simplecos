...
describe "public_carriers/edit" do
  before(:each) do
  ...
  it "renders the edit public_carrier form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => public_carriers_path(@public_carrier), :method => "post" do
