...
describe "sip_clients/new" do
  before(:each) do
    assign(:sip_client, stub_model(SipClient,
      :client => nil,
      :sip_user => "MyString",
      :sip_pass => "MyString",
  ...
  it "renders new sip_client form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => sip_clients_path, :method => "post" do
