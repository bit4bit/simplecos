...
describe "client_cash_plans/new" do
  before(:each) do
    assign(:client_cash_plan, stub_model(ClientCashPlan,
      :client_id => 1,
      :expression => "MyString",
      :bill_rate => 1.5,
      :bill_minimum => 1,
  ...
  it "renders new client_cash_plan form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => client_cash_plans_path, :method => "post" do
