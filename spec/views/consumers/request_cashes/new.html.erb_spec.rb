...
describe "consumers_request_cashes/new" do
  before(:each) do
    assign(:request_cash, stub_model(Consumers::RequestCash,
      :client_id => 1,
      :amount => 1.5,
      :note => "MyText"
    ).as_new_record)
  ...
  it "renders new request_cash form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => consumers_request_cashes_path, :method => "post" do
